  ...
  return (
    <div className="bg-white rounded-md text-gray-500 p-2">
      ...
      {imageToPost &&( 
        ...
        <div className="flex items-center px-4 py-2 space-x-4 filter hover:brightness-110 transition duration-150 curso">
        <Image src="imageToPost" className="h-10 object-contain" atl="imagePost"/>
      </div>)}
